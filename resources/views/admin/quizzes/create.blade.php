...
<script>
  ...
  function addQuestion() {
    ...
    div.innerHTML = `
      ...
      <input type="text" name="questions[${questionCount}][text]" placeholder="Enter your question">
      <label for="questions[${questionCount}][answer]">Answer ${questionCount + 1}</label>
      <input type="text" name="questions[${questionCount}][answer]" placeholder="Enter correct answer">
  ...
  function removeQuestion(button) {
    ...
    // Optionally re-index questions if needed, though backend can handle gaps
  }
</script>
@endpush